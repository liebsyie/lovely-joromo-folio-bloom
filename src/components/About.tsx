          ...
          <ScrollReveal direction="right" delay={300}>
            <div className="relative flex justify-center">
              ...
              <div className="relative group">
                ...
                {/* Photo container */}
                <div className="relative w-80 h-80 rounded-full overflow-hidden border-4 border-slate-700/50 group-hover:border-teal-400/50 transition-all duration-300 shadow-2xl hover:shadow-teal-500/20">
                  <img 
