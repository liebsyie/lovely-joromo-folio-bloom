        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-scale-in delay-300">
            <div className="relative">
              <GlowingCard className="w-80 h-80 mx-auto overflow-hidden" glowColor="teal-500">
                <img 
              ...
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-r from-teal-500/20 to-blue-500/20 rounded-full blur-xl animate-pulse"></div>
              <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full blur-xl animate-pulse delay-1000"></div>
            </div>
          </div>
        </div>
      </div>
